...
\033[1;97m
 ...
 .----------------.  .----------------.  .----------------.  .----------------.  .----------------. 
| .--------------. || .--------------. || .--------------. || .--------------. || .--------------. |
| | ____    ____ | || |      __      | || |    _______   | || | _____  _____ | || |  ________    | |
| ||_   \  /   _|| || |     /  \     | || |   /  ___  |  | || ||_   _||_   _|| || | |_   ___ `.  | |
| |  |   \/   |  | || |    / /\ \    | || |  |  (__ \_|  | || |  | |    | |  | || |   | |   `. \ | |
| |  | |\  /| |  | || |   / ____ \   | || |   '.___`-.   | || |  | '    ' |  | || |   | |    | | | |
| | _| |_\/_| |_ | || | _/ /    \ \_ | || |  |`\____) |  | || |   \ `--' /   | || |  _| |___.' / | |
| ||_____||_____|| || ||____|  |____|| || |  |_______.'  | || |    `.__.'    | || | |________.'  | |
| |              | || |              | || |              | || |              | || |              | |
| '--------------' || '--------------' || '--------------' || '--------------' || '--------------' |
 '----------------'  '----------------'  '----------------'  '----------------'  '----------------' 
...
\033[1;92m══════════════════════════════════════════════════
\33[1;41m\33[1;37m▓░▒░▒▓░▒░▒▓░▒▓░▒▓█[ Masud FREE TOOLS ]█▓▒░▓░▒░▒▓░▒▓░▒▓\33[0m
\033[1;92m══════════════════════════════════════════════════"""
class Main:
	def __init__(self):
		self.id = []
		...
		if Baloch in ["", " "]:
			...
			os.system("xdg-open https://www.facebook.com/Masud")
			print("══════════════════════════════════════════════════")
			time.sleep(3.0)
